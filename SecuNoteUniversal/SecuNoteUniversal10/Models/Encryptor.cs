...
namespace SecuNoteUniversal10.Models
{
    internal class Encryptor
    {
        ...
        public void EncryptString(StringItemViewModel stringToEncrypt)
        {
            ...
            {
                var stringBuffer = CryptographicBuffer.ConvertStringToBinary(stringToEncrypt.Content,
                    BinaryStringEncoding.Utf8);
                var encryptedString = CryptographicEngine.EncryptAndAuthenticate(aesKey, stringBuffer,
                    stringToEncrypt.Nonce,
                    null);
                stringToEncrypt.AuthenticationTag = encryptedString.AuthenticationTag;
                stringToEncrypt.Content = CryptographicBuffer.ConvertBinaryToString(BinaryStringEncoding.Utf8,
