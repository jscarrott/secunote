                ...
                using (var db = new SQLiteConnection(DatabaseHandler.DBPath))
                {
                    try
                    {
                        ...
                        if (existingItem != null)
                        {
                            ...
                            existingItem.AuthenticationTag =
                                CryptographicBuffer.EncodeToBase64String(stringItem.AuthenticationTag);
        ...
        public async Task<AbstractItemViewModel> GetItem(string name)
        {
            ...
            using (var db = new SQLiteConnection(DatabaseHandler.DBPath))
            {
                ...
                if (modelGotten != null)
                {
                    ...
                    stringItemViewModelGotten.AuthenticationTag =
                        CryptographicBuffer.DecodeFromBase64String(modelGotten.AuthenticationTag);
                }
                else
                {
